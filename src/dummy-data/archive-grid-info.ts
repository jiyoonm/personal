import sampleImg from "../../public/static/bg11.jpeg";
const archiveInfo = [
  {
    id: "recharge",
    imgUrl: "/static/recharge/index.jpg",
    tags: ["Backend"],
    mainImage: "/static/recharge/documentation/3.jpg",
    grid: [
      "/static/recharge/documentation/4.jpg",

      "/static/recharge/documentation/tnet.jpeg",
    ],
    sImg: "/static/recharge/documentation/t.jpeg",
    img: "/static/recharge/documentation/1.jpg",
    last: "/static/recharge/documentation/main.jpg",
    finalImage: null,
  ...
  {
    id: "country",
    imgUrl: "/static/country/bg1.jpeg",
    tags: ["Frontend", "UI/UX"],
    year: 2022,
    mainImage: "/static/country/bg1.jpeg",
    grid: null,
    team: "Studio Elsewhere",
    role: ["Creative Technologist", "Software Engineer"],
